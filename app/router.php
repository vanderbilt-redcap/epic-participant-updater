...
$routes = [
    ...
    ['POST', "archives/run-cleanup", ['Vanderbilt\EpicParticipantUpdater\App\Controllers\EpicController/runLogArchiveCleanup', [new CheckRedcapUserMiddleware()]]],
    ...
    ['DELETE', "archives/{month:\d{4}-\d{2}}", ['Vanderbilt\EpicParticipantUpdater\App\Controllers\EpicController/deleteLogArchive', [new CheckRedcapUserMiddleware()]]],
